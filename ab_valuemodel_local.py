#!/usr/bin/env python3
"""Local A/B: learned value model (scorer bonus) ON vs OFF. Same seeds both sides."""
import subprocess
import sys
import re
...
def set_flag(on):
    src = open(SRC).read()
    new = re.sub(r'global _v9ValueModelEnabled = (true|false)',
                 f'global _v9ValueModelEnabled = {"true" if on else "false"}', src)
