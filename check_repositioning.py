...
print("="*80)
print("FALLBACK REPOSITIONING CHECK")
print("="*80)

for log in all_logs[:200]:  # First 200 logs
    msg = log['message']
    if ('Failed to move' in msg or 'fallback repositioning' in msg or
        'Moving to optimal position' in msg or 'Moving toward closest' in msg or
        'Used chip to move' in msg or 'Repositioning to' in msg):
