#!/usr/bin/env python3
"""
LeekWars Auto Solo Fighter - CURE ACCOUNT
Allows selection of specific leek and number of fights via command-line arguments
Usage: python3 lw_solo_fights_flexible_cure.py <leek_number> <num_fights> [--quick]
Example: python3 lw_solo_fights_flexible_cure.py 1 25
         python3 lw_solo_fights_flexible_cure.py 2 50 --quick
"""
...
def main():
    ...
    # Get credentials from config - Cure account
